...
// criação de variáveis para os icones dos botões
...
// função para o botão + retornar tarefas
...
//função para atualizar o local storage todas as vezes que mudar algo na lista de tarefas
